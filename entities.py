"""Fichier contenant les classes des entities du jeu Kidnap the Princess"""
...
class Entity:
	...
	def __init__(self, sons, pv, pm, damage, dico_image, damage_spec):

		#attributs concernant l'apparence du perso
		self.current_image = ""
		self.images = dico_image  # continedra 4 dico : attaque, spec, damage, saut. toutes les images sont vers la droite
		...
		self.amplitude_deplacement = globals.taille_case
		# represente la distance parcourue en px lors de l'animation d'un deplacment
